...
# GabAI APK Build Script - v32
# Includes all fixes: cookie auth, camera callbacks, phone validation, microphone recording

echo "🚀 Building GabAI APK v32 with all fixes..."

# Clean previous builds
echo "🧹 Cleaning previous builds..."
rm -rf www voltbuilder-build gabai-apk-v32*.zip 2>/dev/null
...
<widget id="ai.gabai.app" version="1.32.0" android-versionCode="132" xmlns="http://www.w3.org/ns/widgets" xmlns:android="http://schemas.android.com/apk/res/android">
    <name>GabAI</name>
...
zip -r ../gabai-apk-v32-with-microphone-fix.zip . -x "*.DS_Store" "*__MACOSX*"
cd ..
...
cat > gabai-apk-v32-release-notes.md << 'EOF'
# GabAI APK v32 Release Notes
...
1. Upload `gabai-apk-v32-with-microphone-fix.zip` to VoltBuilder
...
echo "📦 Package: gabai-apk-v32-with-microphone-fix.zip"
echo "📄 Release notes: gabai-apk-v32-release-notes.md"
echo ""
echo "Next steps:"
