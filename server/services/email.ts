...
If you didn't request this, please ignore this email.
  ...
  try {
    // Force development mode until Postmark account is approved
    console.log('🔧 Using development mode - Postmark account pending approval');

    // Always use dev mode until email domain is approved
