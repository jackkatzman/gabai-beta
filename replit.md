...
- **APK Build Challenge** (Aug 10): Persistent Java version conflicts between Capacitor 7.x (Java 21) and GitHub Actions (Java 17). Multiple strategies attempted: Java 17/21 enforcement, Docker isolation, Capacitor downgrade, nuclear file replacement. Implementing React Native CLI fallback for reliable APK generation.
