...
# GabAI APK Build Script - v31
# Includes all fixes: cookie auth, camera callbacks, phone validation

echo "🚀 Building GabAI APK v31 with all fixes..."

# Clean previous builds
echo "🧹 Cleaning previous builds..."
rm -rf www voltbuilder-build gabai-apk-v31*.zip 2>/dev/null
...
<widget id="ai.gabai.app" version="1.31.0" android-versionCode="131" xmlns="http://www.w3.org/ns/widgets" xmlns:android="http://schemas.android.com/apk/res/android">
    <name>GabAI</name>
...
zip -r ../gabai-apk-v31-cookies-camera-phone-fix.zip . -x "*.DS_Store" "*__MACOSX*"
cd ..
...
cat > gabai-apk-v31-release-notes.md << 'EOF'
# GabAI APK v31 Release Notes
...
1. Upload `gabai-apk-v31-cookies-camera-phone-fix.zip` to VoltBuilder
...
echo "📦 Package: gabai-apk-v31-cookies-camera-phone-fix.zip"
echo "📄 Release notes: gabai-apk-v31-release-notes.md"
echo ""
echo "Next steps:"
