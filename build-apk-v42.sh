...
echo "==================================="
echo "Building GabAi APK v42"
echo "Minimal Build - No Camera Plugin"
echo "==================================="
...
# Create config.xml for VoltBuilder - absolute minimum
echo "📝 Creating config.xml for v42 (Minimal)..."
cat > config.xml << 'EOF'
<?xml version="1.0" encoding="UTF-8"?>
<widget id="ai.gabai.app" version="1.0.42" xmlns="http://www.w3.org/ns/widgets" xmlns:cdv="http://cordova.apache.org/ns/1.0">
    <name>GabAi</name>
    ...
    <!-- Minimal plugins - no camera to avoid AndroidX conflicts -->
...
# Create package.json for VoltBuilder - minimal
...
zip -r gabai-apk-v42-minimal.zip www config.xml voltbuilder-package.json

echo "✅ Build complete!"
echo ""
echo "📱 APK v42 Features:"
echo "  - Minimal plugin configuration"
echo "  - No camera plugin (avoiding AndroidX conflicts)"
echo "  - Device and file plugins only"
echo "  - SDK 35 target"
echo "  - Should build without conflicts"
echo ""
echo "📦 Output file: gabai-apk-v42-minimal.zip"
echo ""
echo "🚀 Next steps:"
echo "  1. Upload gabai-apk-v42-minimal.zip to VoltBuilder"
