  ...
  const updateUserMutation = useMutation({
    mutationFn: async (data: OnboardingData) => {
      ...
      try {
        ...
        console.log("📡 Fetching current user with bulletproof API");
        const currentUser = await api('/api/auth/user');
        ...
        const updateData = {
          ...
          preferences: {
            ...
            smsConsentDate: data.smsConsentDate,
          },
        ...
        // Use the legacy API helper for user update
        return await legacyApi.updateUser(currentUser.id, updateData);
