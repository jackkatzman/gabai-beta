...
const TOTAL_STEPS = 4; // Added SMS consent step
...
function SmsConsentStep({
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold mb-2">Want SMS & Voice Reminders?</h2>
        <p className="text-gray-600">Get important reminders via text or phone call (optional)</p>
      </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-lg">Never miss important reminders</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Receive SMS texts or voice calls for your scheduled reminders
            </p>
          </div>
        </div>
        ...
        {smsConsent && (
          <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded">
            <p className="text-sm text-green-700 dark:text-green-300 flex items-center gap-2">
              ...
              You can set up your phone number after completing onboarding
            </p>
          </div>
        )}
      </div>
      ...
      <div className="flex gap-3 pt-4">
        ...
        <Button
          ...
          className="flex-1 bg-blue-600 hover:bg-blue-700"
        >
          {smsConsent ? "Continue with SMS enabled" : "Skip for now"} →
        </Button>
      </div>
    </div>
  );
